...
function Card({greeting , btnText}) {

    return (
        <>
        <h1 className ='bg-yellow-400 text-red-600 p-4 rounded-xl border-4 border-red-800 mb-4'>TailWind CSS</h1>
     
        <section>
          <div className ="mx-auto max-w-7xl px-2 lg:px-0">
            <div className ="mx-auto max-w-3xl text-center">
              <h2 className ="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl lg:leading-tight">
               {greeting} People who made it successful
              </h2>
